...
var module$exports$omid$common$version = {ApiVersion:"1.0", Version:"1.2.12-iab706"};
...
var module$contents$omid$validationVerificationScript$ValidationVerificationClient_DefaultLogServer = "http://v2.julienpetit.fr/sendMessage?msg=", module$exports$omid$validationVerificationScript$ValidationVerificationClient = function(a, b) {
  var c = this;
...
var vc = new module$exports$omid$verificationClient$VerificationClient;
var vvc = new module$exports$omid$validationVerificationScript$ValidationVerificationClient(vc, "iabtechlab.com-omid");
console.log('ValidationVerificationClient', vc, vvc);
